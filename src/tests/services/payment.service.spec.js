// Import TS source explicitly so webpack+ts-loader resolves it
import { createPaymentGateway, formatCardNumber, formatExpiryDate, detectCardType, SimulatedPaymentGateway } from '../../services/payment.service.ts';
describe('PaymentService', () => {
    ...
    describe('Card Number Validation', () => {
        it('should validate correct Visa card numbers', () => {
            expect(paymentGateway.validateCardNumber('4111111111111111')).toBe(true);
            expect(paymentGateway.validateCardNumber('4532015112830366')).toBe(true);
        });
